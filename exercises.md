...
|----------|----------|-------------|------------|-------------------|
| techment_enterprise_rag.md | fixed_size (baseline) | 61 | 496.6 | Thấp — cắt ngang câu |
| techment_enterprise_rag.md | by_sentences (baseline) | 87 | 331.1 | Trung bình — nhiều chunk ngắn |
| techment_enterprise_rag.md | recursive (baseline) | 69 | 433.8 | Cao — giữ cấu trúc |
